import random,time
arr1=[random.randint(0,100) for i in range(100)]
arr2=[random.randint(0,100) for i in range(1000)]
arr3=[random.randint(0,100) for i in range(10000)]
arr4=[random.randint(0,100) for i in range(100000)]
